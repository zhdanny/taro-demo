...
function WeekCalendar2(props){
  let {time, cancelText, confirmText, cancelBtn, confirmBtn, onConfirm, onCancel} = props
  ...
  const yearMonth = (timeDate) => {
    ...
    let dmonth= disabledMonth(selectedMonth.value)
    selectedMonth = {dmonth, ...selectedMonth}
    let arrRight = []
    let arrLeft = []
    for(let i = 0; i < 2; i++){
      ...
      let dmr= disabledMonth(right.value)
      ...
      let dml= disabledMonth(left.value)
